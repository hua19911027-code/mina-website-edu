...
# 順序  | 檔案                                    | 說明
# ──────┼─────────────────────────────────────────┼───────────────────────────────
#  1    | Mina_題庫系統_封板規格_V1_0.md          | 基礎架構（未被後版覆蓋的章節全部有效）
#  2    | Mina_題庫系統_補充規格_V1.1.md          | 覆蓋：資料源改 Notion、三個 API 規格、archive 流程
#  3    | Mina_題庫系統_封板規格_V2.0.md          | 新增：AI 出題、審核機制、學年管理、出版社分析
#  4    | Mina_網站主規格_V2.0_修訂摘要.md        | 覆蓋：Master Spec 的題庫相關章節
#
# 衝突原則：版號越高越優先。
